...
class PermissionRequestFileProvider {
    ...
    async checkPermissionRequest() {
        ...
        if (!(await fs.pathExists(path))) {
            return teamsfx_api_1.err(teamsfx_api_1.returnUserError(new Error(`${this.permissionFileName} is missing`), _1.CoreSource, constants_1.SolutionError.MissingPermissionsJson));
        }
