...
async function migrateToArmAndMultiEnv(ctx) {
    ...
    try {
        ...
        const projectSettings = loadRes.value;
        if (!tools_1.isSPFxProject(projectSettings) && !((_a = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.solutionSettings) === null || _a === void 0 ? void 0 : _a.migrateFromV1)) {
...
async function migrateMultiEnv(projectPath, log) {
    ...
    const { hasFrontend, hasBackend, hasBot, hasBotCapability, hasMessageExtensionCapability, isSPFx, hasProvision, migrateFromV1, } = await queryProjectStatus(fx);
    //localSettings.json
    const localSettingsProvider = new localSettingsProvider_1.LocalSettingsProvider(projectPath);
    await localSettingsProvider.save(localSettingsProvider.init(hasFrontend, hasBackend, hasBot, migrateFromV1));
