import { FxError, Inputs, Result } from "@microsoft/teamsfx-api";
...
export declare function downloadSample(inputs: Inputs, ctx: CoreHookContext): Promise<Result<string, FxError>>;
