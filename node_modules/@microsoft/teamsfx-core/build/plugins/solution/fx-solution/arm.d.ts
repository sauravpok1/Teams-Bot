...
export declare function generateArmTemplateV3(ctx: v2.Context, inputs: v2.InputsWithProjectPath, activatedPlugins: v3.ResourcePlugin[], addedPlugins: v3.ResourcePlugin[]): Promise<Result<any, FxError>>;
...
declare class Arm {
    generateArmTemplate(ctx: v2.Context, inputs: v2.InputsWithProjectPath, activatedPlugins: v3.ResourcePlugin[], addedPlugins: v3.ResourcePlugin[]): Promise<Result<any, FxError>>;
