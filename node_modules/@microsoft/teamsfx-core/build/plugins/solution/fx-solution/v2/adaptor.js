...
class BaseSolutionContextAdaptor {
    constructor() {
        this.envInfo = tools_1.newEnvInfo();
        this.root = "";
...
class ScaffoldingContextAdapter extends BaseSolutionContextAdaptor {
    constructor(params) {
        ...
        this.envInfo = tools_1.newEnvInfo(); // tbd
    }
}
    ...
    _generateArmTemplates(fn) {
        return async (ctx) => {
            if (!ctx.ui ||
                ...
                !ctx.projectSettings ||
                !ctx.answers) {
                return teamsfx_api_1.err(teamsfx_api_1.returnSystemError(new Error(`invalid plugin context`), __1.SolutionSource, __1.SolutionError.InternelError));
            }
            const v2ctx = {
