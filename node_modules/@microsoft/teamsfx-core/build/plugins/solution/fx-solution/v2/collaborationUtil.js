...
class CollaborationUtil {
    static async getCurrentUserInfo(graphTokenProvider) {
        ...
        if (!user) {
            return teamsfx_api_1.err(teamsfx_api_1.returnSystemError(new Error("Failed to retrieve current user info from graph token."), constants_1.SolutionSource, constants_1.SolutionError.FailedToRetrieveUserInfo));
        }
