...
exports.configLocalDebugSettings = exports.setupLocalDebugSettings = void 0;
...
const certificate_1 = require("./util/certificate");
async function setupLocalDebugSettings(ctx, inputs, localSettings) {
    ...
    let skipNgrok = (_a = localSettings === null || localSettings === void 0 ? void 0 : localSettings.bot) === null || _a === void 0 ? void 0 : _a.skipNgrok;
    ...
    try {
        ...
        if (inputs.platform === teamsfx_api_1.Platform.VSCode || inputs.platform === teamsfx_api_1.Platform.CLI) {
            const isMigrateFromV1 = projectSettingsHelper_1.ProjectSettingsHelper.isMigrateFromV1(ctx.projectSetting);
...
async function configLocalDebugSettings(ctx, inputs, localSettings) {
    ...
    const includeAAD = projectSettingsHelper_1.ProjectSettingsHelper.includeAAD(ctx.projectSetting);
    const includeSimpleAuth = projectSettingsHelper_1.ProjectSettingsHelper.includeSimpleAuth(ctx.projectSetting);
    let trustDevCert = (_a = localSettings === null || localSettings === void 0 ? void 0 : localSettings.frontend) === null || _a === void 0 ? void 0 : _a.trustDevCert;
    const telemetryProperties = {
        platform: inputs.platform,
        frontend: includeFrontend ? "true" : "false",
        function: includeBackend ? "true" : "false",
        ...
        if (inputs.platform === teamsfx_api_1.Platform.VSCode || inputs.platform === teamsfx_api_1.Platform.CLI) {
            ...
            if (includeFrontend) {
                ...
                try {
                    ...
                    const certManager = new certificate_1.LocalCertificateManager(ctx, inputs);
            ...
            if (includeBot) {
                ...
                if (isMigrateFromV1) {
                    botEnvs.teamsfxLocalEnvs[localEnvProvider_1.EnvKeysBotV1.BotId] = botId;
                    botEnvs.teamsfxLocalEnvs[localEnvProvider_1.EnvKeysBotV1.BotPassword] = botPassword;
                }
                else {
