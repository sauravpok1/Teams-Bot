import { FxError, Result, SolutionConfig, SolutionContext, AzureAccountProvider, SubscriptionInfo, Inputs, UserInteraction, LogProvider, v2, Void } from "@microsoft/teamsfx-api";
import { ResourceManagementClient } from "@azure/arm-resources";
export declare type AzureSubscription = {
    displayName: string;
    subscriptionId: string;
};
declare type ResourceGroupInfo = {
 ...
 *
 */
export declare function checkSubscription(envInfo: v2.EnvInfoV2, azureAccountProvider: AzureAccountProvider): Promise<Result<SubscriptionInfo, FxError>>;
/**
 * check m365 tenant is right
 *
 */
export declare function checkM365Tenant(envInfo: v2.EnvInfoV2, appStudioJson: object): Promise<Result<Void, FxError>>;
/**
 * Ask user to create a new resource group or use an exsiting resource group
 */
export declare function askResourceGroupInfo(ctx: SolutionContext, rmClient: ResourceManagementClient, inputs: Inputs, ui: UserInteraction, defaultResourceGroupName: string): Promise<Result<ResourceGroupInfo, FxError>>;
/**
