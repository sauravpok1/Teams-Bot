import { AzureSolutionSettings, Func, FxError, Plugin, PluginContext, QTreeNode, Result, Solution, SolutionContext, Stage } from "@microsoft/teamsfx-api";
import { ListCollaboratorResult, PermissionsResult } from "../../../common/permissionInterface";
import { AppStudioPlugin, SpfxPlugin } from "../../resource";
export declare type LoadedPlugin = Plugin;
export declare type PluginsWithContext = [LoadedPlugin, PluginContext];
export declare enum SolutionRunningState {
    Idle = "idle",
...
export declare class TeamsAppSolution implements Solution {
    ...
    fillInV1SolutionSettings(ctx: SolutionContext): Promise<Result<AzureSolutionSettings, FxError>>;
    /**
     * create
     */
    ...
    listAllCollaborators(ctx: SolutionContext): Promise<Result<Record<string, ListCollaboratorResult>, FxError>>;
