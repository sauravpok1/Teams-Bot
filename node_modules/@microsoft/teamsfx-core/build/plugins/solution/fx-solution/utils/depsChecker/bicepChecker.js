...
class BicepChecker {
    ...
    async handleInstallFailed() {
        ...
        throw new teamsfx_api_1.SystemError(common_1.DepsCheckerEvent.bicepInstallError, common_1.Messages.failToInstallBicep.split("@NameVersion").join(displayBicepName), source);
    }
...
function sendSystemErrorEvent(eventName, errorMessage, errorStack, telemetry) {
    const error = new teamsfx_api_1.SystemError(eventName, `errorMsg=${errorMessage},errorStack=${errorStack}`, source, errorStack);
