...
class SimpleAuthPluginImpl {
    async localDebug(ctx) {
        ...
        if (common_2.isMultiEnvEnabled()) {
            (_b = (_a = ctx.localSettings) === null || _a === void 0 ? void 0 : _a.auth) === null || _b === void 0 ? void 0 : _b.set(localSettingsConstants_1.LocalSettingsAuthKeys.SimpleAuthFilePath, simpleAuthFilePath);
        }
        else {
            ctx.config.set(constants_1.Constants.SimpleAuthPlugin.configKeys.filePath, simpleAuthFilePath);
        }
    ...
    async postLocalDebug(ctx) {
        ...
        const configs = common_1.Utils.getWebAppConfig(ctx, true);
        const configArray = [];
        for (const [key, value] of Object.entries(configs)) {
            configArray.push(`${key}="${value}"`);
        }
        if (common_2.isMultiEnvEnabled()) {
            (_b = (_a = ctx.localSettings) === null || _a === void 0 ? void 0 : _a.auth) === null || _b === void 0 ? void 0 : _b.set(localSettingsConstants_1.LocalSettingsAuthKeys.SimpleAuthEnvironmentVariableParams, configArray.join(" "));
        }
        else {
            ctx.config.set(constants_1.Constants.SimpleAuthPlugin.configKeys.environmentVariableParams, configArray.join(" "));
        }
