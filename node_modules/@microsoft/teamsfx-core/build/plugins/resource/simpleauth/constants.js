...
Constants.RegisterRersourceProviderFailed = (message) => `Failed to register required resource provider for Simple Auth. Reason: ${message}. Register required resource provider ${Constants.RequiredResourceProviders.join(",")} manually.`;
Constants.FreeServerFarmsQuotaErrorFromAzure = "The maximum number of Free ServerFarms allowed in a Subscription is 10";
Constants.FreeServerFarmsQuotaErrorToUser = "The maximum number of Free App Service Plan allowed in a Subscription is 10. Delete a free App Service plan and try again.";
