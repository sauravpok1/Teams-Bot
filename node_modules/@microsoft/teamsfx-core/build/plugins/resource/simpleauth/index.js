...
let SimpleAuthPlugin = class SimpleAuthPlugin {
    ...
    activate(solutionSettings) {
        if ((solutionSettings === null || solutionSettings === void 0 ? void 0 : solutionSettings.migrateFromV1) || __1.isVsCallingCli()) {
            return false;
        }
    ...
    async provision(ctx) {
        if (__1.isArmSupportEnabled()) {
            ...
            return this.runWithSimpleAuthError(() => this.simpleAuthPluginImpl.provision(ctx), ctx, constants_1.Messages.EndProvision.telemetry);
        }
    }
    ...
    async runWithSimpleAuthError(fn, ctx, stage) {
        ...
        try {
            ...
            if (e instanceof teamsfx_api_1.SystemError || e instanceof teamsfx_api_1.UserError) {
                ...
                telemetry_1.TelemetryUtils.sendErrorEvent(stage, errors_1.UnhandledError.name, constants_1.Telemetry.systemError, errors_1.UnhandledError.message(e === null || e === void 0 ? void 0 : e.message));
