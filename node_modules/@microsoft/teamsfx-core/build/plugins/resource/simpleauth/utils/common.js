...
class Utils {
    ...
    static getWebAppConfig(ctx, isLocalDebug) {
        ...
        const allowedAppIds = tools_2.getAllowedAppIds().join(";");
    ...
    static getClientId(ctx, isLocalDebug) {
        ...
        if (tools_1.isMultiEnvEnabled()) {
            ...
            clientId = Utils.getConfigValueWithValidation(ctx, constants_1.Constants.AadAppPlugin.id, constants_1.Constants.AadAppPlugin.configKeys.clientId, isLocalDebug);
        }
        return clientId;
    }
    static getClientSecret(ctx, isLocalDebug) {
        ...
        if (tools_1.isMultiEnvEnabled()) {
            ...
            clientSecret = Utils.getConfigValueWithValidation(ctx, constants_1.Constants.AadAppPlugin.id, constants_1.Constants.AadAppPlugin.configKeys.clientSecret, isLocalDebug);
        }
        return clientSecret;
    }
    static getFrontendEndpoint(ctx, isLocalDebug) {
        ...
        if (tools_1.isMultiEnvEnabled()) {
            ...
            tabEndpoint = Utils.getConfigValueWithValidation(ctx, isLocalDebug ? constants_1.Constants.LocalDebugPlugin.id : constants_1.Constants.FrontendPlugin.id, isLocalDebug
                ? constants_1.Constants.LocalDebugPlugin.configKeys.endpoint
                : constants_1.Constants.FrontendPlugin.configKeys.endpoint);
        }
        return tabEndpoint;
    }
    static getOauthAuthority(ctx, isLocalDebug) {
        ...
        if (tools_1.isMultiEnvEnabled()) {
            ...
            oauthAuthority = Utils.getConfigValueWithValidation(ctx, constants_1.Constants.AadAppPlugin.id, constants_1.Constants.AadAppPlugin.configKeys.oauthAuthority);
        }
        return oauthAuthority;
    }
    static getApplicationIdUris(ctx, isLocalDebug) {
        var _a, _b;
        let applicationIdUris;
        if (tools_1.isMultiEnvEnabled()) {
            ...
            applicationIdUris = Utils.getConfigValueWithValidation(ctx, constants_1.Constants.AadAppPlugin.id, constants_1.Constants.AadAppPlugin.configKeys.applicationIdUris, isLocalDebug);
        }
