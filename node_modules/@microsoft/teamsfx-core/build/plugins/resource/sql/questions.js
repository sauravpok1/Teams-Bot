...
exports.adminNameQuestion = {
    ...
    title: constants_1.Constants.userQuestion.adminName,
    type: "text",
    validation: {
...
exports.adminPasswordQuestion = {
    ...
    title: constants_1.Constants.userQuestion.adminPassword,
    type: "text",
    password: true,
    validation: {
        validFunc: async (input, previousInputs) => {
...
exports.confirmPasswordQuestion = {
    ...
    title: constants_1.Constants.userQuestion.confirmPassword,
    type: "text",
    password: true,
    validation: {
        validFunc: async (input, previousInputs) => {
