...
let LocalDebugPluginV2 = class LocalDebugPluginV2 {
    ...
    async executeUserTask(ctx, inputs, func, localSettings, envInfo, tokenProvider) {
        ...
        if (func.method == "getLaunchInput") {
            ...
            return teamsfx_api_1.ok(((_b = localSettings === null || localSettings === void 0 ? void 0 : localSettings.bot) === null || _b === void 0 ? void 0 : _b.skipNgrok) === true);
        }
        else if (func.method === "getLocalDebugEnvs") {
            const localEnvs = await localEnvManager.getLocalDebugEnvs(inputs.projectPath, ctx.projectSetting, localSettings);
