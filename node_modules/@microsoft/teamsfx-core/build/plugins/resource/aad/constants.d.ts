...
export declare class Messages {
    ...
    static readonly NoSelection = "No Azure AD app found. Will not update permissions. You need to run provision or local debug first.";
    static readonly UserCancelled = "Selection is cancelled by user.";
    static readonly UpdatePermissionSuccessMessage = "Successfully updated permission for Azure AD app. You can go to Azure Portal to check the permission or grant admin consent.";
