...
exports.AadAppForTeamsPlugin = void 0;
...
let AadAppForTeamsPlugin = class AadAppForTeamsPlugin {
    ...
    async executeUserTask(func, ctx) {
        ...
        return teamsfx_api_1.err(new teamsfx_api_1.SystemError("FunctionRouterError", `Failed to route function call:${JSON.stringify(func)}`, constants_1.Plugins.pluginNameShort, undefined, constants_2.Links.ISSUE_LINK));
    }
