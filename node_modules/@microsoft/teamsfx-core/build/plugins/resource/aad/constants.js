...
Messages.NoSelection = "No Azure AD app found. Will not update permissions. You need to run provision or local debug first.";
Messages.UserCancelled = "Selection is cancelled by user.";
Messages.UpdatePermissionSuccessMessage = "Successfully updated permission for Azure AD app. You can go to Azure Portal to check the permission or grant admin consent.";
Messages.SkipProvision = "Azure AD app provision skipped. You need to mannual provision and config Azure AD app.";
Messages.OwnerAlreadyAdded = (userObjectId, objectId) => `User ${userObjectId} is already added as owner of Azure AD app ${objectId}.`;
Messages.StepFailedAndSkipped = (stage, helpMessage) => `Failed in step: ${stage}. You need to go to Azure Protal and mannually ${helpMessage} for the provided Azure AD app.`;
Messages.UpdatePermissionHelpMessage = `update the permission under "API permissions"`;
Messages.UpdateAppIdUriHelpMessage = (appIdUri) => `set "${appIdUri}" as "Application ID URI" under "Expose an API"`;
Messages.UpdateRedirectUriHelpMessage = (redirectUri) => `set "${redirectUri}" as "Redirect URIs" under "Authentication"`;
class ProgressTitle {
}
