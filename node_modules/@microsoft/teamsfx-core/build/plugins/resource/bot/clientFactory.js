...
exports.ensureResourceProvider = exports.findResourceProvider = exports.createResourceProviderClient = exports.createWebSiteMgmtClient = exports.createAzureBotServiceClient = void 0;
...
function createAzureBotServiceClient(creds, subs) {
    if (!subs) {
        throw new errors_1.ClientCreationError(strings_1.ClientNames.BOT_SERVICE_CLIENT);
    }
    try {
        return new arm_botservice_1.AzureBotService(creds, subs);
    }
    catch (e) {
        throw new errors_1.ClientCreationError(strings_1.ClientNames.BOT_SERVICE_CLIENT, e);
    }
}
exports.createAzureBotServiceClient = createAzureBotServiceClient;
function createWebSiteMgmtClient(creds, subs) {
    if (!subs) {
        throw new errors_1.ClientCreationError(strings_1.ClientNames.BOT_SERVICE_CLIENT);
    }
    try {
        ...
        throw new errors_1.ClientCreationError(strings_1.ClientNames.WEB_SITE_MGMT_CLIENT, e);
    }
}
exports.createWebSiteMgmtClient = createWebSiteMgmtClient;
