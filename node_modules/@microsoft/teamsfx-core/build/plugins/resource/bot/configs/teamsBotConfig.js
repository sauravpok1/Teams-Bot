...
class TeamsBotConfig {
    ...
    async restoreConfigFromContext(context) {
        ...
        const capabilities = ((_e = context.projectSettings) === null || _e === void 0 ? void 0 : _e.solutionSettings)
            .capabilities;
        if ((capabilities === null || capabilities === void 0 ? void 0 : capabilities.includes(pluginActRoles_1.PluginActRoles.Bot)) && !this.actRoles.includes(pluginActRoles_1.PluginActRoles.Bot)) {
        ...
        const resourceNameSuffixValue = (_f = context.envInfo.state
