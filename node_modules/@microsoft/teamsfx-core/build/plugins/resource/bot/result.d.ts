...
export declare class FxBotPluginResultFactory {
    static readonly source: string;
    static readonly defaultHelpLink: string;
    static readonly defaultIssueLink: string;
    static UserError(errorName: string, errorMessage: string, innerError?: any, helpLink?: string): FxResult;
    static SystemError(errorName: string, errorMessage: string, innerError?: any): FxResult;
