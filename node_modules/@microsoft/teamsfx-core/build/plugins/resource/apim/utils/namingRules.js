...
NamingRules.resourceGroupName = {
    minLength: constants_1.ValidationConstants.defaultMinLength,
    maxLength: 90,
    validPattern: constants_1.ValidationConstants.resourceGroupValidPattern,
};
NamingRules.apimServiceName = {
    minLength: constants_1.ValidationConstants.defaultMinLength,
    maxLength: 50,
    validPattern: constants_1.ValidationConstants.serviceIdValidPattern,
    sanitize(appName, suffix) {
