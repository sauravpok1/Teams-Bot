...
export declare class QuestionConstants {
    ...
    static readonly VSCode: {
        ...
        readonly Apim: {
            ...
            readonly createNewApimOption: string;
        };
    ...
    static readonly CLI: {
        new (): {};
        readonly ApimResourceGroup: {
            new (): {};
            readonly questionName: string;
            readonly description: string;
        };
        readonly ApimServiceName: {
            new (): {};
            readonly questionName: string;
            readonly description: string;
        };
...
export declare class ValidationConstants {
    ...
    static readonly resourceGroupValidPattern: {
        regex: RegExp;
        message: string;
    };
    static readonly serviceIdValidPattern: {
        regex: RegExp;
        message: string;
    };
...
export declare class ApimPluginConfigKeys {
    ...
    static readonly productId: string;
    static readonly oAuthServerId: string;
...
export declare enum RetryOperation {
