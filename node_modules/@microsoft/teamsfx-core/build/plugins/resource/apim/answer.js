...
class VSCodeAnswer extends BaseAnswer {
    ...
    get resourceGroupName() {
        var _a;
        const apimService = (_a = this.getOptionItem(constants_1.QuestionConstants.VSCode.Apim.questionName)) === null || _a === void 0 ? void 0 : _a.data;
        return apimService === null || apimService === void 0 ? void 0 : apimService.resourceGroupName;
    }
    get apimServiceName() {
        var _a;
        const apimService = (_a = this.getOptionItem(constants_1.QuestionConstants.VSCode.Apim.questionName)) === null || _a === void 0 ? void 0 : _a.data;
        return apimService === null || apimService === void 0 ? void 0 : apimService.serviceName;
    }
    get apiDocumentPath() {
        var _a;
    ...
    save(lifecycle, apimConfig) {
        var _a, _b, _c, _d;
        switch (lifecycle) {
            case constants_1.PluginLifeCycle.Scaffold:
                apimConfig.resourceGroupName = (_a = this.resourceGroupName) !== null && _a !== void 0 ? _a : apimConfig.resourceGroupName;
                apimConfig.serviceName = (_b = this.apimServiceName) !== null && _b !== void 0 ? _b : apimConfig.serviceName;
                break;
            case constants_1.PluginLifeCycle.Deploy:
                apimConfig.apiDocumentPath = (_c = this.apiDocumentPath) !== null && _c !== void 0 ? _c : apimConfig.apiDocumentPath;
                apimConfig.apiPrefix = (_d = this.apiPrefix) !== null && _d !== void 0 ? _d : apimConfig.apiPrefix;
                break;
        }
    }
}
...
class CLIAnswer extends BaseAnswer {
    ...
    get resourceGroupName() {
        return this.getString(constants_1.QuestionConstants.CLI.ApimResourceGroup.questionName);
    }
    get apimServiceName() {
        return this.getString(constants_1.QuestionConstants.CLI.ApimServiceName.questionName);
    }
    get apiDocumentPath() {
        ...
        switch (lifecycle) {
            case constants_1.PluginLifeCycle.Scaffold:
                ...
                if (typeof this.resourceGroupName !== "undefined") {
                    const message = namingRules_1.NamingRules.validate(this.resourceGroupName, namingRules_1.NamingRules.resourceGroupName);
                    if (message) {
                        return `${constants_1.ValidationConstants.CLI.invalidOptionMessage(constants_1.QuestionConstants.CLI.ApimResourceGroup.questionName)} ${message}`;
                    }
                }
                if (typeof this.apimServiceName !== "undefined") {
                    const message = namingRules_1.NamingRules.validate(this.apimServiceName, namingRules_1.NamingRules.apimServiceName);
                    if (message) {
                        return `${constants_1.ValidationConstants.CLI.invalidOptionMessage(constants_1.QuestionConstants.CLI.ApimServiceName.questionName)} ${message}`;
                    }
                }
                break;
            case constants_1.PluginLifeCycle.Deploy:
