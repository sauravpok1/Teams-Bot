...
exports.FuncPluginTelemetry = void 0;
...
class FuncPluginTelemetry {
    ...
    sendEvent(eventName, properties = {}, timecost) {
        const measurements = {};
        if (timecost) {
            measurements[common_1.TelemetryMessurement.completionTime] = timecost;
        }
    ...
    sendUserErrorEvent(eventName, errorMessage) {
        const error = new teamsfx_api_1.UserError(eventName, errorMessage, this._source);
    ...
    sendSystemErrorEvent(eventName, errorMessage, errorStack) {
        const error = new teamsfx_api_1.SystemError(eventName, `errorMsg=${errorMessage},errorStack=${errorStack}`, this._source, errorStack);
        telemetry_helper_1.TelemetryHelper.sendErrorEvent(eventName, error, FuncPluginTelemetry.getCommonProps());
    }
}
exports.FuncPluginTelemetry = FuncPluginTelemetry;
