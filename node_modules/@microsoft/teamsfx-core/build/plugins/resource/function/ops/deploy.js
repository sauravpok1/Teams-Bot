...
const backendExtensionsInstall_1 = require("../utils/depsChecker/backendExtensionsInstall");
...
class FunctionDeploy {
    ...
    static async installFuncExtensions(ctx, componentPath, language) {
        ...
        const dotnetChecker = new dotnetChecker_1.DotnetChecker(new funcPluginAdapter_1.FuncPluginAdapter(ctx, telemetry), funcPluginLogger_1.funcPluginLogger, telemetry);
        const backendExtensionsInstaller = new backendExtensionsInstall_1.BackendExtensionsInstaller(dotnetChecker, funcPluginLogger_1.funcPluginLogger);
