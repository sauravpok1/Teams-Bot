...
const __1 = require("../../..");
require("./v2");
const plugin_2 = require("./blazor/plugin");
const constants_2 = require("./blazor/constants");
let FrontendPlugin = FrontendPlugin_1 = class FrontendPlugin {
    constructor() {
        ...
        this.blazorPluginImpl = new plugin_2.BlazorPluginImpl();
    }
    ...
    static setContext(ctx) {
        ...
        telemetry_helper_1.TelemetryHelper.setContext(ctx, __1.isVsCallingCli() ? constants_2.BlazorPluginInfo.pluginName : constants_1.FrontendPluginInfo.PluginName);
    }
    async scaffold(ctx) {
    ...
    async preProvision(ctx) {
        ...
        FrontendPlugin_1.setContext(ctx);
        return this.runWithErrorHandling(ctx, constants_1.TelemetryEvent.PreProvision, () => __1.isVsCallingCli()
    ...
    async postProvision(ctx) {
        FrontendPlugin_1.setContext(ctx);
        return this.runWithErrorHandling(ctx, constants_1.TelemetryEvent.PostProvision, () => __1.isVsCallingCli()
    ...
    async preDeploy(ctx) {
        ...
        FrontendPlugin_1.setContext(ctx);
        return this.runWithErrorHandling(ctx, constants_1.TelemetryEvent.PreDeploy, () => this.frontendPluginImpl.preDeploy(ctx));
    }
    async deploy(ctx) {
        FrontendPlugin_1.setContext(ctx);
        return this.runWithErrorHandling(ctx, constants_1.TelemetryEvent.Deploy, () => __1.isVsCallingCli() ? this.blazorPluginImpl.deploy(ctx) : this.frontendPluginImpl.deploy(ctx));
    }
    async updateArmTemplates(ctx) {
        ...
        FrontendPlugin_1.setContext(ctx);
        return this.runWithErrorHandling(ctx, constants_1.TelemetryEvent.UpdateArmTemplates, () => this.frontendPluginImpl.updateArmTemplates(ctx));
    }
    async generateArmTemplates(ctx) {
        ...
        FrontendPlugin_1.setContext(ctx);
        return this.runWithErrorHandling(ctx, constants_1.TelemetryEvent.GenerateArmTemplates, () => this.frontendPluginImpl.generateArmTemplates(ctx));
    }
    async executeUserTask(func, ctx) {
        ...
        FrontendPlugin_1.setContext(ctx);
        return this.runWithErrorHandling(ctx, constants_1.TelemetryEvent.ExecuteUserTask, () => this.frontendPluginImpl.executeUserTask(func, ctx), { method: func.method });
    }
        ...
        try {
            ...
            if (e instanceof errors_1.FrontendPluginError) {
                const error = e.errorType === errors_1.ErrorType.User
                    ? error_factory_1.ErrorFactory.UserError(e.code, e.getMessage(), undefined, undefined, e.helpLink)
                    : error_factory_1.ErrorFactory.SystemError(e.code, e.getMessage(), e.getInnerError(), (_a = e.getInnerError()) === null || _a === void 0 ? void 0 : _a.stack);
            ...
            const error = error_factory_1.ErrorFactory.SystemError(errors_1.UnhandledErrorCode, errors_1.UnhandledErrorMessage, e, e.stack);
            telemetry_helper_1.TelemetryHelper.sendErrorEvent(stage, error, properties);
            return teamsfx_api_1.err(error);
        }
    }
