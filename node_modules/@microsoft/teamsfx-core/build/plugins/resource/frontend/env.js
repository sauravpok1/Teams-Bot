...
async function loadEnvFile(envPath) {
    try {
        ...
        const error = new errors_1.FileSystemError(messages_1.Messages.FailedLoadEnv(envPath));
...
async function saveEnvFile(envPath, envs) {
    ...
    try {
        ...
        logger_1.Logger.error(e.toString());
        const error = new errors_1.FileSystemError(messages_1.Messages.FailedSaveEnv(envPath));
        logger_1.Logger.error(error.toString());
