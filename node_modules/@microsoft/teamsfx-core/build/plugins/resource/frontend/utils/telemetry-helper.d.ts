...
export declare class TelemetryHelper {
    ...
    static sendErrorEvent(eventName: string, e: SystemError | UserError | FrontendPluginError, properties?: {
        [key: string]: string;
    }, measurements?: {
        [key: string]: number;
    }): void;
    static sendScaffoldFallbackEvent(e: FrontendPluginError, properties?: {
        [key: string]: string;
    }, measurements?: {
        [key: string]: number;
    }): void;
    static sendGeneralEvent(eventName: string, properties?: {
        [key: string]: string;
    }, measurements?: {
        [key: string]: number;
    }): void;
