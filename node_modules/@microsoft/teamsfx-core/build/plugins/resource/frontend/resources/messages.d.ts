export declare class Messages {
    ...
    static readonly ProgressEnableStorageStaticWebsite = "Enabling Azure Storage account static website.";
    ...
    static readonly StartPostProvision: (name: string) => string;
    static readonly EndPostProvision: (name: string) => string;
    ...
    static readonly EndDeploy: (name: string) => string;
    static readonly StartGenerateArmTemplates: (name: string) => string;
    static readonly EndGenerateArmTemplates: (name: string) => string;
    static readonly StartUpdateArmTemplates: (name: string) => string;
    static readonly EndUpdateTemplates: (name: string) => string;
    ...
    static readonly StartCheckResourceGroupExistence: (name: string) => string;
    static readonly StartCheckStaticWebsiteEnabled: (name: string) => string;
    static readonly StartCreateStorageAccount: (name: string, resourceGroupName: string) => string;
    ...
    static readonly FailedFetchManifest: (url: string) => string;
    static readonly FailedFetchZip: (url: string) => string;
