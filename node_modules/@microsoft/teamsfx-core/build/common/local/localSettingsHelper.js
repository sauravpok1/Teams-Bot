...
async function convertToLocalEnvs(projectPath, projectSettings, localSettings, logger) {
    ...
    const isMigrateFromV1 = projectSettingsHelper_1.ProjectSettingsHelper.isMigrateFromV1(projectSettings);
    // prepare config maps
    ...
    const clientId = authConfigs === null || authConfigs === void 0 ? void 0 : authConfigs.get(constants_1.LocalSettingsAuthKeys.ClientId);
    const clientSecret = authConfigs === null || authConfigs === void 0 ? void 0 : authConfigs.get(constants_1.LocalSettingsAuthKeys.ClientSecret);
    const applicationIdUri = authConfigs === null || authConfigs === void 0 ? void 0 : authConfigs.get(constants_1.LocalSettingsAuthKeys.ApplicationIdUris);
    const teamsAppTenantId = teamsAppConfigs === null || teamsAppConfigs === void 0 ? void 0 : teamsAppConfigs.get(constants_1.LocalSettingsTeamsAppKeys.TenantId);
    const localAuthEndpoint = authConfigs === null || authConfigs === void 0 ? void 0 : authConfigs.get(constants_1.LocalSettingsAuthKeys.SimpleAuthServiceEndpoint);
    const localTabEndpoint = frontendConfigs === null || frontendConfigs === void 0 ? void 0 : frontendConfigs.get(constants_1.LocalSettingsFrontendKeys.TabEndpoint);
    const localFuncEndpoint = backendConfigs === null || backendConfigs === void 0 ? void 0 : backendConfigs.get(constants_1.LocalSettingsBackendKeys.FunctionEndpoint);
    const localEnvs = {};
    if (includeFrontend) {
        localEnvs[constants_1.LocalEnvFrontendKeys.Browser] = frontendConfigs === null || frontendConfigs === void 0 ? void 0 : frontendConfigs.get(constants_1.LocalSettingsFrontendKeys.Browser);
        localEnvs[constants_1.LocalEnvFrontendKeys.Https] = frontendConfigs === null || frontendConfigs === void 0 ? void 0 : frontendConfigs.get(constants_1.LocalSettingsFrontendKeys.Https);
        if (!isMigrateFromV1) {
        ...
        localEnvs[constants_1.LocalEnvCertKeys.SslCrtFile] = frontendConfigs === null || frontendConfigs === void 0 ? void 0 : frontendConfigs.get(constants_1.LocalSettingsFrontendKeys.SslCertFile);
        localEnvs[constants_1.LocalEnvCertKeys.SslKeyFile] = frontendConfigs === null || frontendConfigs === void 0 ? void 0 : frontendConfigs.get(constants_1.LocalSettingsFrontendKeys.SslKeyFile);
    }
    if (includeBot) {
        // bot local env
        if (projectSettingsHelper_1.ProjectSettingsHelper.isMigrateFromV1(projectSettings)) {
            localEnvs[constants_1.LocalEnvBotKeysMigratedFromV1.BotId] = botConfigs === null || botConfigs === void 0 ? void 0 : botConfigs.get(constants_1.LocalSettingsBotKeys.BotId);
            localEnvs[constants_1.LocalEnvBotKeysMigratedFromV1.BotPassword] = botConfigs === null || botConfigs === void 0 ? void 0 : botConfigs.get(constants_1.LocalSettingsBotKeys.BotPassword);
        }
        else {
            localEnvs[constants_1.LocalEnvBotKeys.BotId] = botConfigs === null || botConfigs === void 0 ? void 0 : botConfigs.get(constants_1.LocalSettingsBotKeys.BotId);
            localEnvs[constants_1.LocalEnvBotKeys.BotPassword] = botConfigs === null || botConfigs === void 0 ? void 0 : botConfigs.get(constants_1.LocalSettingsBotKeys.BotPassword);
            ...
            localEnvs[constants_1.LocalEnvBotKeys.LoginEndpoint] = `${botConfigs === null || botConfigs === void 0 ? void 0 : botConfigs.get(constants_1.LocalSettingsBotKeys.BotEndpoint)}/auth-start.html`;
    ...
    try {
        ...
        if (includeFrontend) {
            const customEnvs = (await localEnvProvider.loadFrontendLocalEnvs(includeBackend, includeAAD, isMigrateFromV1)).customizedLocalEnvs;
