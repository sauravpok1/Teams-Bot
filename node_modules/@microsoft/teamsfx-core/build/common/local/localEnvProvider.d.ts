...
export declare const EnvKeysBotV1: Readonly<{
    BotId: string;
    BotPassword: string;
}>;
...
export declare class LocalEnvProvider {
    ...
    loadFrontendLocalEnvs(includeBackend: boolean, includeAuth: boolean, isMigrateFromV1: boolean): Promise<LocalEnvs>;
    loadBackendLocalEnvs(): Promise<LocalEnvs>;
    loadBotLocalEnvs(isMigrateFromV1: boolean): Promise<LocalEnvs>;
    saveLocalEnvs(frontendEnvs: LocalEnvs | undefined, backendEnvs: LocalEnvs | undefined, botEnvs: LocalEnvs | undefined): Promise<void>;
    initFrontendLocalEnvs(includeBackend: boolean, includeAuth: boolean, isMigrateFromV1: boolean): LocalEnvs;
    initBackendLocalEnvs(): LocalEnvs;
    initBotLocalEnvs(isMigrateFromV1: boolean): LocalEnvs;
