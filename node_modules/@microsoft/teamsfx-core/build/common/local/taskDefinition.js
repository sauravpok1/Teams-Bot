...
exports.TaskDefinition = exports.NpmTaskDefinition = void 0;
...
class TaskDefinition {
    ...
    static backendStart(workspaceFolder, programmingLanguage, funcCommand, enableLanguageWorker) {
        ...
        const args = programmingLanguage === constants_1.ProgrammingLanguage.typescript
    ...
    static botStart(workspaceFolder, programmingLanguage, enableInspect) {
        ...
        const command = programmingLanguage === constants_1.ProgrammingLanguage.typescript
    ...
    static ngrokStart(workspaceFolder, skipNgrok, ngrokBinFolder) {
        var _a;
        return {
            name: "ngrok start",
            command: skipNgrok
            ...
            env: {
                PATH: `${ngrokBinFolder}${path_1.default.delimiter}${(_a = process.env.PATH) !== null && _a !== void 0 ? _a : ""}`,
            },
            cwd: path_1.default.join(workspaceFolder, constants_1.FolderName.Bot),
            execOptions: {
                needShell: true,
