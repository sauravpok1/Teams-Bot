...
exports.LocalEnvProvider = exports.EnvKeysBotCustom = exports.EnvKeysBotV1 = exports.EnvKeysBot = exports.EnvKeysBackendCustom = exports.EnvKeysBackend = exports.EnvKeysFrontend = void 0;
...
exports.EnvKeysBotV1 = Object.freeze({
    BotId: "BotId",
...
class LocalEnvProvider {
    ...
    async loadFrontendLocalEnvs(includeBackend, includeAuth, isMigrateFromV1) {
        ...
        return envs !== null && envs !== void 0 ? envs : this.initFrontendLocalEnvs(includeBackend, includeAuth, isMigrateFromV1);
    }
    ...
    async loadBotLocalEnvs(isMigrateFromV1) {
        ...
        return envs !== null && envs !== void 0 ? envs : this.initBotLocalEnvs(isMigrateFromV1);
    }
    ...
    initFrontendLocalEnvs(includeBackend, includeAuth, isMigrateFromV1) {
        const result = {
            teamsfxLocalEnvs: {},
            customizedLocalEnvs: {},
        };
    ...
    initBotLocalEnvs(isMigrateFromV1) {
        const result = {
            teamsfxLocalEnvs: {},
            customizedLocalEnvs: {},
        };
        if (isMigrateFromV1) {
            result.teamsfxLocalEnvs[exports.EnvKeysBotV1.BotId] = "";
            result.teamsfxLocalEnvs[exports.EnvKeysBotV1.BotPassword] = "";
        }
        else {
