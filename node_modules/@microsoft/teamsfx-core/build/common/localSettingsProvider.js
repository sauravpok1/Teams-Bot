...
class LocalSettingsProvider {
    ...
    init(includeFrontend, includeBackend, includeBotOrMessageExtension, migrateFromV1 = false) {
    ...
    initV2(includeFrontend, includeBackend, includeBotOrMessageExtension, migrateFromV1 = false) {
        const localSettings = {
            teamsApp: {
    ...
    incrementalInitV2(localSettingsJson, addBackaned, addBot, addFrontend) {
    ...
    initFrontend() {
        ...
        frontendLocalConfig.set(localSettingsConstants_1.LocalSettingsFrontendKeys.TrustDevCert, true);
    ...
    initBot() {
        ...
        for (const key of keys) {
            if (key === localSettingsConstants_1.LocalSettingsBotKeys.SkipNgrok) {
